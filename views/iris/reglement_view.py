...
_RULES: list[tuple[str, str, str]] = [
    ...
    ("💬", "Salons",
     "Afin de garder un **cadre d'échange** __agréable__ : Le **spam** de __messages__, de __mentions__ ou d'__émojis__ est **interdit**. "
     "Tout comme l'**utilisation abusive** de __majuscules__ et le **flood**. De plus, la **seule langue** __autorisée__ est le **français** pour la bonne __compréhension__ de tous. "
    ...
    ("🎙️", "Vocal",
     ...
     "dans le but de **perturber** un salon __vocal__ est également interdit et sanctionnable."),

    ("🚫", "Contenu illégal",
     "Les propos **racistes**, **homophobes**, **grossophobes**, **antisémites** ou incitant à la **haine**, "
     "ainsi que tous autres propos __interdits__ par la **loi française** sont **formellement interdits** et feront l'objet de **sanctions** __très lourde__. " 
     "De manière générale tout contenu **violents**, **choquants**, **inappropriés** est __formellement interdit__ sur le serveur."),

    ("📢", "Publicité",
     "Toute **publicité** __extérieures__ à NationsGlory sont **strictement interdite** sur le serveur Discord, "
     "qu'elles concernent **Minecraft®** ou non. Le **démarchage** via les __messages privés__ est aussi **prohibé**."),
    ...
    ("🔐", "Vie privée (dox)",
     ...
     "d'un __autre membre__, même avec son **consentement** pourra entraîner un __bannissement__ de nos **services**."),
...
def build_reglement_view(fresh_files: list[discord.File]) -> LayoutView:
    ...
    c.add_item(TextDisplay(
        ...
        "allant du **rappel à l'ordre** jusqu'au **bannissement** __définitif__.\n\n"

        "Si vous êtes **victime** ou **témoin** d'une quelconque infraction nuisant à la bonne tenue de ce Discord, "
