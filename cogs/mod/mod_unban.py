"""
cogs/mod/mod_unban.py — Commande /mod unban (interface : liste des membres bannis).

Prend zero parametre : la cible est choisie dans le panneau, a partir de
guild.bans() (les membres bannis ne peuvent pas etre retrouves via un
UserSelect natif, limite aux membres actuels du serveur).
"""
