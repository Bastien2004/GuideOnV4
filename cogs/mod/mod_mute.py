"""
cogs/mod/mod_mute.py — Commande /mod mute (panneau interactif).
"""
...
@app_commands.command(name="mute", description="🔇 Rend un membre muet temporairement (interface)")
async def mod_mute(interaction: discord.Interaction) -> None:
    ...
    view = SanctionBuilderView(
        sanction_type=SanctionType.MUTE, guild=interaction.guild, moderator_id=interaction.user.id,
    )
