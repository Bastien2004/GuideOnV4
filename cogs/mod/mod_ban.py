"""
cogs/mod/mod_ban.py — Commande /mod ban (panneau interactif).
"""
...
@app_commands.command(name="ban", description="🔨 Bannit définitivement un membre du serveur (interface)")
async def mod_ban(interaction: discord.Interaction) -> None:
    ...
    view = SanctionBuilderView(
        sanction_type=SanctionType.BAN, guild=interaction.guild, moderator_id=interaction.user.id,
    )
