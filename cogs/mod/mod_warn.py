"""
cogs/mod/mod_warn.py — Commande /mod warn (panneau interactif).
"""
...
@app_commands.command(name="warn", description="⚠️ Avertit un membre (interface)")
async def mod_warn(interaction: discord.Interaction) -> None:
    ...
    view = SanctionBuilderView(
        sanction_type=SanctionType.WARN, guild=interaction.guild, moderator_id=interaction.user.id,
    )
